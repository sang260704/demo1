...
public class ChuyenDeDAO extends EduSysDAO<ChuyenDe, String> {
    ...
    String SELECT_BY_TENCD_SQL = "SELECT * FROM ChuyenDe WHERE TenCD = ?";
    ...
    public List<ChuyenDe> selectByTenCD(String tenCD) {
        return selectBySQL(SELECT_BY_TENCD_SQL, tenCD);
    }
