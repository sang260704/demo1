...
public class NguoiHocDAO extends EduSysDAO<NguoiHoc, String> {
    ...
    public NguoiHoc selectByEmail(String email) {
        String SELECT_BY_EMAIL_SQL = "SELECT * FROM NguoiHoc WHERE Email=?";
        List<NguoiHoc> list = selectBySQL(SELECT_BY_EMAIL_SQL, email);
        if (list.isEmpty()) {
            return null;
        }
        return list.get(0);
